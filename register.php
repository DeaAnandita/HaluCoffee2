			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Role">
						...
						<span class="focus-input100" data-placeholder="Masukkan Role"></span>
					</div>
				...
				if (isset($_POST['submit'])) {
					...
					if ($username == '' || $password == '' || $role == '') {
						...
						$query=$conn->query("INSERT INTO pelanggan(username, password,role) VALUES('$username','$password','$role')");
						if ($query) {
							echo "<br>";
