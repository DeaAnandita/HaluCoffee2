...
<div class="form-group">
	...
	<div class="form-group">
		...
		<img src="../foto_produk/<?php echo $data['foto_produk']; ?>" width="80" height="80">
	</div>
	<div class="form-group">
...
if (isset($_POST['submit'])) {
	...
	if (!empty($lokasifoto)) {
		...
		$conn->query("UPDATE produk SET kategori='$_POST[kategori]', nama_produk='$_POST[nama]',harga_produk='$_POST[harga]',stok='$_POST[stok]',foto_produk='$namafoto',deskripsi_produk='$_POST[deskripsi]' WHERE id_produk='$_GET[id]'");
	}
	else{
		$conn->query("UPDATE produk SET kategori='$_POST[kategori]',nama_produk='$_POST[nama]',harga_produk='$_POST[harga]',stok='$_POST[stok]',deskripsi_produk='$_POST[deskripsi]' WHERE id_produk='$_GET[id]'");
	}
